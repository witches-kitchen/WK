...
public class SumacFoliagePlacer
    ...
    @Override
    protected void m_fdoszgvu(TestableWorld world, BiConsumer<BlockPos, BlockState> replacer, RandomGenerator random, TreeFeatureConfig config, int i, TreeNode treeNode, int foliageHeight, int radius, int offset) {
