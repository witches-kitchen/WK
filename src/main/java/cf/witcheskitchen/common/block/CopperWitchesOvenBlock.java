...
public class CopperWitchesOvenBlock extends WitchesOvenBlock implements WeatheringCopper {
    private final WeatheringCopper.WeatherState oxidizationLevel;

    public CopperWitchesOvenBlock(Properties settings, WeatheringCopper.WeatherState oxidizationLevel) {
        super(settings);
