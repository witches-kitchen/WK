...
public interface WKBlockEntityTypes {
    ...
    BlockEntityType<WKTeapotEntity> TEAPOT = register("teapot", WKTeapotEntity::new, WKBlocks.TEAPOT, WKBlocks.COPPER_TEAPOT, WKBlocks.WAXED_COPPER_TEAPOT, WKBlocks.EXPOSED_COPPER_TEAPOT, WKBlocks.WAXED_EXPOSED_COPPER_TEAPOT, WKBlocks.WEATHERED_COPPER_TEAPOT, WKBlocks.WAXED_WEATHERED_COPPER_TEAPOT, WKBlocks.OXIDIZED_COPPER_TEAPOT, WKBlocks.WAXED_OXIDIZED_COPPER_TEAPOT);
